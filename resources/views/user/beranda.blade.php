        ...
        <div class="container p-5 animated-element">
            <div class="row">
                <div class="col-lg-4  p-5 ">
                    <img src="img/LOGO SI.png" class="img-fluid mx-auto rounded-circle" alt="">
                </div>
                <div class="col-lg-5 offset-lg-3 d-flex flex-column justify-content-center align-items-start  mt-5 ">
                                    ...
                                    <div class="overflow-hidden" style="width: 300px; height:128px">
                                        ...
                                        @else
                                            <img class="object-fit-cover img-fluid "
                                                src="{{ asset('storage/' . $item->gambar) }}" alt="Card image cap">
                                        @endif

                                    </div>
                                    <div class="card-body overflow-hidden ">
                                        <a href=""
                                            class="badge bg-secondary text-white  fw-light">{{ $item->divisi->nama }}</a>
                                        <h5 class="card-title fs-6 my-2">
                                            <a href="/kegiatan/{{ $item->slug }}" class="text-black">
                                                {{ $item->batasi($item->nama) }}
                                            </a>
                                        </h5>
                                        <h6 class="card-subtitle mb-2 text-muted fw-light fs-6">
    ...
    <section class="bg-body-tertiary">
        <div class="container p-5 ">
            ...
            <div class="row " style="color: #1245ba;">
                <div class="col-lg-4 rounded order-lg-1 mb-5  animated-element hover-scale">
                    <div
                ...
                <div class="col-lg-3 offset-lg-1 mb-5 animated-element hover-scale">
                    <div
                ...
                <div class="col-lg-3 rounded over overflow-hidden mb-5 order-lg-5 animated-element hover-scale">
                            ...
                            <div class="card-body px-1 py-3" style="height: 175px;">
                                <div class="row">
                                    ...
                                    <div class="col rounded-1">
                                        ...
                                        <p class="card-text fs-6 lh-lg"><i class="bi bi-person-fill text-primary"></i>Nur
